...
const About = () => {
  return (
    <div>
      <img src={about} alt="Hero" className="aboutSectionImg" />
      <div className="aboutUs">
        ...
        <div className="storySection">
          <div className="textSection">
            <h2>Our Story</h2>
            <p className="paragraph">
              Welcome to Laundryless, a women-owned business proudly based in
              the vibrant city of Austin, Texas. Our journey began with a simple
              idea: to transform the mundane chore of laundry into a convenient,
              ...
              for households and businesses alike, offering personalized care
              for your garments with the utmost dedication and professionalism.
            </p>
          </div>
        ...
        <div className="missionSection">
          ...
          <div className="textSection">
            ...
            <p className="paragraph">
              ...
              customers with fast, reliable, and eco-friendly solutions,
              allowing you to focus on what truly matters. By integrating
              cutting-edge technology with a personal touch, we ensure that your
              laundry is handled with the care it deserves, delivered right to
              your doorstep.
            </p>
          </div>
        </div>
